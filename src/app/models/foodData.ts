...
export const FOOD_ITEMS: Fooditem[] = [
  {
    ...
    rating: 4.3,
    price: 13,
    img: 'assets/Veg Seekh Kabab.jpg',
    quantity: 1,
    description:
      'vegetable seekh kabab with detailed photo and video recipe. this is an adaptation to the famous minced meat seekh kabab for veggie lovers or vegetarians. basically a tandoor platter starter / appetizer which can be served with either mint chutney or sauce.',
  },
  {
    id: 2,
    ...
    rating: 4.3,
    price: 13,
    img: 'assets/Paneer Chilly Dry.jpg',
    quantity: 1,
    description:
      'Chilli Paneer is a popular restaurant style Indo Chinese starter that is great for a dinner party with friends and family. A spicy, tangy paneer recipe that you can serve as it is or along with a bowl of rice. Loved by kids and adults alike, this is a quick and easy recipe made in just under 30 minutes! This recipe yields one of the best chilli paneer dry that pairs well with a veg fried rice, schezwan fried rice, hakka noodles for the main course or can be served as a starter.',
  },
  {
    id: 3,
    ...
    rating: 4.3,
    price: 13,
    img: 'assets/Veg Manchurian Dry.jpg',
    quantity: 1,
    description:
      'This is the Indo Chinese starter dish where fried vegetable balls are coated with thick, flavorful sauce. Since this is the dry version there is no gravy.',
  },
  {
    id: 4,
    name: 'chicken tikka',
  ...
  },
  {
    ...
    rating: 4.3,
    price: 13,
    img: 'assets/Chicken lollipop.jpg',
    quantity: 1,
    description:
      'Meat that is luscious, rich, sweet, and zesty. Among the crispy finger-licking chicken appetisers from Indo-Chinese cuisine, this Chicken lollipop is one of the most loved chicken wings starters. It is essentially a recipe for crispy batter-fried chicken wings made using chicken drumettes and wingettes. The inside of these fried chicken wings is juicy and flavorful, while the exterior is superbly crispy. Served with spicy schezwan sauce or sweet chilli garlic dip, its heavenly taste will make you crave it regularly!',
  },
  {
    id: 6,
    name: 'Veg crispy',
  ...
  },
  {
    ...
    rating: 4.3,
    price: 13,
    img: 'assets/veg spring rolls.jpg',
    quantity: 1,
    description:
  ...
  },
  {
    ...
    rating: 4.3,
    price: 13,
    img: 'assets/Chicken Chilli.jpg',
    quantity: 1,
    description:
      'The quintessential chinese recipe, chilli chicken is one of the most popular Indo-Chinese style chicken appetizer or starter. This delicious chicken recipe is very popular in Chinese restaurants but with this easy recipe you can make it at the comfort of your home - according to your own taste.',
  },
  {
    id: 9,
    name: 'Kadai paneer',
  ...
  },
  {
    ...
    rating: 4.3,
    price: 13,
    img: 'assets/paneer tikka masala.jpg',
    quantity: 1,
    description:
  ...
  },
  {
    ...
    rating: 4.3,
    price: 13,
    img: 'assets/bhuna gosht.jpg',
    quantity: 1,
    description:
      'Bhuna means “fried” and gosht means “mutton or lamb”. Bhuna Gosht (Mutton Bhuna) is a popular North Indian dish where mutton pieces are cooked in a lip-smacking semi-dry gravy made using lots of onions, yoghurt, and spices.',
  },
  {
    id: 14,
    name: 'egg curry',
  ...
  },
  {
    ...
    rating: 4.3,
    price: 13,
    img: 'assets/lachha paratha.jpg',
    quantity: 1,
    description:
      'lachha paratha recipe | lachha parantha recipe with step by step photo and video recipe. lachha paratha is a popular paratha recipe prepared in ease. it is very similar to kerala paratha however, taste different. there are many ways of preparing lachha parantha in india. however, i have showed, two simple way of creating perfect layers. lachha paratha doesn’t require more oil as of kerala parota.',
  },
  {
    id: 22,
    name: 'Chapati',
  ...
  },
  {
    ...
    rating: 4.3,
    price: 13,
    img: 'assets/shahi tukda.jpg',
    quantity: 1,
    description:
      'For making shahi tukda: 6 bread slices, 4 tbsp ghee, ½ cup sugar, a few saffron (kesar) strands, a pinch of cardamom (elaichi) powder. Shahi Tukda is a simple yet delicious recipe, which makes for a delightful treat for sweet lovers. Here’s a simple recipe to make this traditional Shahi Tukda recipe at home. Take a saucepan and heat water along with sugar, once the sugar dissolves add the saffron strands. Let it boil, till the syrup achieves two string consistency. Once the sugar syrup turns a little thick, turn off the stove and keep it aside..',
  },
  {
    id: 26,
    name: 'Gulab Jamun',
  ...
  },
  {
    ...
    rating: 4.3,
    price: 13,
    img: 'assets/rasgulla.jpg',
    quantity: 1,
    description:
      'Rasgulla is basically soft, spongy balls of cottage cheese that are soaked in chilled sugar syrup. It melts in your mouth and makes a sweet treat that originated in eastern India',
  },
  {
    id: 28,
    name: 'rasmalai',
    ...
    rating: 4.3,
    price: 13,
    img: 'assets/rasmalai.jpg',
    quantity: 1,
    description:
      'This is the easiest way to make homemade rossomalai (as we call in the Bengali Language)! Here spongy, soft rasgulla are simmered in thick, sweet, creamy, saffron-flavored milk.',
  },
  {
    id: 29,
    name: 'kesar kheer',
    ...
    rating: 4.3,
    price: 13,
    img: 'assets/kesar kheer.jpg',
    quantity: 1,
    description:
      'Kheer is a traditional dessert from India cuisine which is a delicious dessert made of rice, milk and sugar. Traditionally, made from rice, but can also be made from sago and vermicelli, even you can make the delicious kheer with grated carrots. The delicious kheer is made by boiling rice in milk until the rice is cooked well and the milk becomes thick. Green cardamom gives it a nice aromatic taste. Dry-fruits fill it with flavor and health. Recipe of Kesar Rice Kheer is very easy.',
  },
  {
    id: 30,
    name: 'rabdi',
    ...
    rating: 4.3,
    price: 13,
    img: 'assets/rabdi.jpg',
    quantity: 1,
    description:
      'Rabdi is the simplest Indian dessert which is made by simmering the milk on low heat until it reduces to 1/3rd to 1/4th of it’s original volume. It’s often flavored with nuts, cardamom, saffron and served in earthen clay pots. ',
  },
  {
    id: 31,
    name: 'kulfi falooda',
